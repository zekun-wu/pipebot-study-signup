...
export const CONSENT_SECTIONS = [
  {
    ...
    paragraphs: [
      ...
      "The goal of this study is to evaluate different interface designs for visualizing AI agent execution. In particular, we study whether real-time execution traces and post-hoc workflow graph visualizations help users understand, verify, debug, and reuse AI-agent workflows.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "use visualizations such as real-time execution traces or post-hoc workflow graphs;",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "For in-lab studies, compensation will be approximately 15 Euros per hour, provided as cash, bank transfer, or gift card. If you come to the university, parking fees may be reimbursed where applicable.",
      "For online or crowdsourcing studies, compensation will be provided through the relevant study platform and will follow the payment conditions stated in the study advertisement.",
    ],
  },
  {
